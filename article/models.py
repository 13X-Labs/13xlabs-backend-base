...
class Category(MPTTModel):
    ...
    parent = TreeForeignKey('self', on_delete=models.CASCADE, null=True,
                            blank=True, related_name='children', verbose_name='Parent Category')

    def __str__(self):
        return self.title

    def get_absolute_url(self):
        return reverse('article:category-detail', kwargs={'slug': self.slug})
...
class Article(models.Model):
    ...
    background = models.ImageField(
        blank=True, upload_to='article/images', verbose_name='Background Image')
    ...
    attachment = models.FileField(
        blank=True, upload_to='article/files', verbose_name='Attachment')
    uploadtime = models.DateField(
        auto_now_add=True, verbose_name='Upload Time')
